 ...
 */
public final class Face_Tracker extends MainActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        connectbt = (Switch) findViewById(R.id.connection);
    ...
    private class GraphicFaceTrackerFactory implements MultiProcessor.Factory<Face> {
        ...
        public Tracker<Face> create(Face face) {
            return new GraphicFaceTracker(mGraphicOverlay, Face_Tracker.this);
        }
    }
